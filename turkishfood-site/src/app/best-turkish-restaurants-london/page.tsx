...
import { ArticleSchema, BreadcrumbSchema, LocalBusinessListSchema } from '@/components/Schema'
...
export default function PillarPage() {
  ...
  return (
    <>
      <ArticleSchema
        title="The 25 Best Turkish Restaurants in London (2025)"
        description="The definitive guide to Turkish food in London. Not the tourist traps. The places where Turkish Londoners actually eat."
        url="https://turkishfoodinlondon.com/best-turkish-restaurants-london"
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: '25 Best Turkish Restaurants', url: 'https://turkishfoodinlondon.com/best-turkish-restaurants-london' },
        ]}
      />
      <LocalBusinessListSchema businesses={allRestaurants} />
